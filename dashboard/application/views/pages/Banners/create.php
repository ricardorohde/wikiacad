                ...
                <div class="box-body">
                    <form action="banners/create" role="form" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="file" class="input-lg" required name="imagem" id="imagem"  title="escolha uma imagem"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea placeholder="destaque" name="destaque2" class="textarea"></textarea>
                        </div>
